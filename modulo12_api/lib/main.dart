...
final _router = GoRouter(
  ...
  routes: [
    ...
    // Paso 1 → cuando termines, reemplaza PantallaTemporal por PantallaPaso1Users()
    ...
    // Paso 2 → reemplaza por PantallaPaso2Users()
  ...
  Widget build(BuildContext context) {
    const pasos = [
      ...
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · JSONPlaceholder',
        icono: Icons.network_ping,
        color: Color.fromARGB(255, 123, 248, 21),
      ),
      _PasoInfo(
        ruta: '/paso2',
        titulo: 'Paso 2',
      ...
      _PasoInfo(
        ...
        detalle: 'TodoDto.fromJson · lista de tareas',
        icono: Icons.data_object,
        color: Color.fromARGB(255, 76, 2, 173),
      ),
      _PasoInfo(
        ruta: '/paso3',
        titulo: 'Paso 3',
