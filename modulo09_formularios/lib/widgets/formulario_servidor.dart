      ...
      child: Column(
        ...
        children: [
          ...
          TextFormField(
            ...
            validator: (v) {
              if (v == null || v.isEmpty) return 'La IP es obligatoria';
              if (!_regexIp.hasMatch(v))  return 'Formato inválido (ej. 00:1A:2B:3C:4D:5E)';
              final octetos = v.split('.').map(int.parse).toList();
              if (octetos.any((o) => o > 255)) return 'Octeto fuera de rango (0–255)';
              return null;
            },
          ...
          SwitchListTile(
            ...
            subtitle:  const Text('Servicios de Mac'),
            value:     _ssl,
            onChanged: (v) => setState(() => _ssl = v),
            secondary: const Icon(Icons.security),
          ),
          ...
          SwitchListTile(
            title:     const Text('Servicios'),
            subtitle:  const Text('Servicio de suscripcion'),
            value:     _ssl,
            onChanged: (v) => setState(() => _ssl = v),
            secondary: const Icon(Icons.security),
          ),
          ...
          SwitchListTile(
            title:     const Text('Servicios'),
            subtitle:  const Text('Servicio web'),
            value:     _ssl,
            onChanged: (v) => setState(() => _ssl = v),
            secondary: const Icon(Icons.security),
          ),
          ...
          SwitchListTile(
            title:     const Text('Servicios'),
            subtitle:  const Text('Servicio de desarrollador'),
            value:     _ssl,
            onChanged: (v) => setState(() => _ssl = v),
            secondary: const Icon(Icons.security),
          ),
          ...
          SwitchListTile(
            title:     const Text('Servicios'),
            subtitle:  const Text('Servicio de google'),
            value:     _ssl,
            onChanged: (v) => setState(() => _ssl = v),
            secondary: const Icon(Icons.security),
          ),
